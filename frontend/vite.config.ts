...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      // ABSENCE_MANAGEMENT_PLAN.md — same '/prefix/api' collision as above
      // ('/absences' and '/absences/...' are React Router pages too).
      '/absences/api': { target: 'http://127.0.0.1:5001', changeOrigin: true },
