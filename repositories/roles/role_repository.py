...
class RoleRepository:
    ...
    def get_permissions(self, role_id: int) -> dict:
        ...
        Przykład: {'workers': {'has_access': True, 'read_only': False, 'own_data': False}, ...}
        """
    ...
    def set_permissions(self, role_id: int, permissions: dict):
        ...
        permissions = {
            'workers': {'has_access': True, 'read_only': False, 'own_data': False},
            ...
        }
        Akceptuje też stary format {'workers': True} dla kompatybilności wstecznej.
        """
        query = """
